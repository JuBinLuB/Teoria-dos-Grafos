...
class Graph:
  ...
  def is_complete(self) -> bool:
    ...
    """
    for node in self.adj:
      if len(self.adj[node]) < self.num_nodes - 1:
        return False
    return True
  ...
  def node_with_highest_degree_in(self) -> Any:    
    ...
    """
    highest_degree_in = 0
    node_of_highest = None
    for node in self.adj:
      degree_in_node = self.degree_in(node)
      if degree_in_node > highest_degree_in:
        highest_degree_in = degree_in_node
        node_of_highest = node
    return node_of_highest
  ...
  def node_with_highest_degree_out(self) -> Any:    
    ...
    """
    highest_degree_out = 0
    node_of_highest = None
    for node in self.adj:
      if len(self.adj[node]) > highest_degree_out:
        highest_degree_out = len(self.adj[node])
        node_of_highest = node
    return node_of_highest
